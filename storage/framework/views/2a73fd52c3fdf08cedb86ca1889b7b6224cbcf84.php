...
<div class="container">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a data-toggle="tab" href="#TabRservar"><?php echo e(__('label.reserva_teatros')); ?></a></li>
	</ul>
				...
				<div class="row gutter">
					...
					<div class="col-md-2 col-sm-6 col-xs-12">
						<ul class="tasks pull-right clearfix">
							<button id="btnNuevoReserva" name="btnNuevoReserva" type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-reserva"><i class="icon-circle-plus icon-left"></i><?php echo e(__('label.nuevo')); ?></button>
						</ul>
					</div>
				</div>
			</div>
	...
	<script>
		var RutaListarReserva = '<?php echo route('reserva.listar'); ?>';
		var RutaGuardarReserva = '<?php echo route('reserva.guardar'); ?>';
		var RutaEditarReserva = '<?php echo route('reserva.editar'); ?>';
		var RutaEliminarReserva = '<?php echo route('reserva.eliminar'); ?>';
		var RutaGetTeatro = '<?php echo route('teatro.get_teatros'); ?>';
		var RutaGeZona = '<?php echo route('zona.get_zonas'); ?>';
