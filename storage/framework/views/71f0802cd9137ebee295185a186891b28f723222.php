		...
		<div class="row gutter">
			...
			<div class="col-md-2 col-sm-6 col-xs-12">
				<ul class="tasks pull-right clearfix">
					<button id="btnNuevoTeatro" name="btnNuevoTeatro" type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-registro"><i class="icon-circle-plus icon-left"></i><?php echo e(__('label.nuevo')); ?></button>
				</ul>
			</div>
		</div>
	</div>
	...
	<script>
		var RutaListar = '<?php echo route('teatro.listar'); ?>';
		var RutaGuardar = '<?php echo route('teatro.guardar'); ?>';
		var RutaEditar = '<?php echo route('teatro.editar'); ?>';
		var RutaEliminar = '<?php echo route('teatro.eliminar'); ?>';
